            ...
            <Table>
              ...
              <TableBody>
                {displayedExpenses.map((expense) => {
                  ...
                  const fullCategoryName = getCategoryName(expense.categoryId);
                  const categoryParts = fullCategoryName.split(' / ');
                  const displayCategoryName = categoryParts.length > 1 ? categoryParts[categoryParts.length - 1] : categoryParts[0];
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span className="hidden sm:inline-block font-medium truncate max-w-[120px] xl:max-w-[180px] cursor-default">
                                {displayCategoryName}
                              </span>
                            </TooltipTrigger>
                            {fullCategoryName !== displayCategoryName && (
                              <TooltipContent>
                                <p>{fullCategoryName}</p>
                              </TooltipContent>
                            )}
                          </Tooltip>
                           <span className="sm:hidden font-medium truncate max-w-[70px]"> {/* For smaller screens */}
                            {displayCategoryName}
                          </span>
                        </div>
                      </TableCell>
